...
public class AnamneseApplication {
	...
	// TODO 1: Estruturar o model principal, anamnese, que seria uma junção de vários outros models:
	//  1 - Alergias Alimentares (Um pra muitos) | 2 - Condições de Saúde (Um pra muitos) | 3 - Dietas (Um pra muitos)
